  ...
  return (
    <section className="hero">
      <div className="container hero__grid">
        ...
        <div className="hero-report" aria-label="Приклад тендерного звіту">
      ...
      <div className="hero__ticker" aria-hidden="true"><span>ДЕДЛАЙНИ</span><i>◆</i><span>ВИМОГИ</span><i>◆</i><span>РИЗИКИ</span><i>◆</i><span>ДОКАЗИ</span><i>◆</i><span>РІШЕННЯ</span></div>
    </section>
  );
}
