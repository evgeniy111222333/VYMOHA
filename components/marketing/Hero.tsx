...
export function Hero() {
  return <section className="hero hero-v3">
    ...
    <div className="hero-v3__metrics"><div className="container"><span><b>3×</b> рівні глибини</span><span><b>32</b> категорії вимог</span><span><b>8</b> документів за перевірку</span><span><b>1</b> доказовий звіт</span></div></div>
  </section>;
}
