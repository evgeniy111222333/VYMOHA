  ...
  return (
    <footer className="site-footer">
      <div className="container site-footer__grid">
        ...
        <div><strong>Продукт</strong><Link href="/analyze">Аналізатор</Link><Link href="/dashboard" prefetch={false}>Кабінет</Link><Link href="/dashboard/billing" prefetch={false}>Тарифи</Link></div>
