...
- якщо дедлайн подання минув або статус процедури закритий/кваліфікація (status !== 'active.tendering'), ОБОВ'ЯЗКОВО вкажи в першому реченні summary, що прийом пропозицій закритий, та додай у risks критичний ризик 'Дедлайн подання минув';
